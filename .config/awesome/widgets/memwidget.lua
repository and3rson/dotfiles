...
return function(s)
    ...
    local widget = utils.make_row{
        ...
        wibox.widget{
            ...
            wibox.container.margin(mem_widget, 0, 0, 0, s.panel.height / 2 - 3),
            wibox.container.mirror(wibox.container.margin(mem_widget, 0, 0, 0, s.panel.height / 2 - 3), {vertical=true}),
            layout=layout
        }
    }
    return widget
